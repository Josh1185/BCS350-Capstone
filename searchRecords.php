...
<body>
  ...
  <form class="searchForm" action="searchRecords.php" method="post">
...
<?php
  ...
  if (isset($_SESSION['username'])) {
      ...
      try {
        ...
        if ($stmt->rowCount() >= 1) {
          ...
          while ($row = $stmt->fetch()) {
            ...
            echo "<tr> <td>" . $player_id . "</td> <td>" . $name . "</td> <td>" . $age . "</td> <td>" . $position . "</td> <td>" . $current_team . "</td> <td>" . $draft_year . "</td> <td>" . $college . "</td></tr>";
          }
    ...
    echo "<p>You must be logged in to search records.</p>";
